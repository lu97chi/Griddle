...
function (_Component) {
  ...
  function RowDefinition() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(RowDefinition).apply(this, arguments));
  }
...
_defineProperty(RowDefinition, "propTypes", {
  ...
  childColumnName: _propTypes.default.string,
